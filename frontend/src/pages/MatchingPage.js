...
function MatchingPage() {
  ...
  }, [matchingModal.isOpen, qtyInputModal.isOpen, matchingHistoryModal.isOpen]);
  ...
  return (
    <div className="matching-page">
      ...
      {qtyInputModal.isOpen && createPortal(
        <div className="modal-overlay" onClick={handleQtyInputCancel}>
          <div 
      ...
      {matchingHistoryModal.isOpen && createPortal(
        <div className="modal-overlay" onClick={closeMatchingHistoryModal}>
          <div 
                ...
                {matchingHistoryModal.matchings.map((m) => (
                  <div key={m.matching_id} className="matching-history-card">
                    ...
                    <button
                      ...
                      onClick={() => handleCancelExistingMatching(m.matching_id)}
                    >
                      취소
                    </button>
                  </div>
